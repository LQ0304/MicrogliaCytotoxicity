...
for res in range(0, 4):
    ...
    load_data_path = os.path.join('./data/save_data_BM_FS/', s)
    ...
    for i in range(0, num_data):
        ...
        '''不同建模方法：RF、SVM、GBDT'''
        # '''RF_Classifier_model'''
        # save_model_path = os.path.join('./data/FS_BM_RF_Results/', s)
        # os.makedirs(save_model_path, exist_ok=True)
        #
        # save_data_path = './data/FS_BM_RF_Results/'
        ...
        save_data_path = './data/FS_BM_SVM_Results/'
        os.makedirs(save_data_path, exist_ok=True)

        save_model_path = os.path.join('./data/FS_BM_SVM_Results/', s)
        os.makedirs(save_model_path, exist_ok=True)
        ...
        # # '''GBDT model'''
        # save_data_path = './data/FS_BM_GBDT_Results/'
        # os.makedirs(save_data_path, exist_ok=True)
        #
        # save_model_path = os.path.join('./data/FS_BM_GBDT_Results/', s)
        # os.makedirs(save_model_path, exist_ok=True)
        #
