...
res_list = [0, 1, 2, 3, 4, 5, 6, 7, 8]
# res_list = [3, 4, 5, 6, 7, 8]
...
for res in res_list:
    ...
    for i in range(0, num_data):
        ...
        save_model_path = os.path.join('./data/random_RF_Results/', s)
        os.makedirs(save_model_path, exist_ok=True)

        save_data_path = './data/random_RF_Results/'
        ...
        pre_train_y = RF_model.predict(train_x)
        pre_test_y = RF_model.predict(test_x)
        joblib.dump(RF_model, os.path.join(save_model_path, 'Random_RF_' + s + str(i) + '.pkl'))

        # '''SVM_classifier_Model'''
        # save_data_path = './data/random_SVM_Results/'
        # os.makedirs(save_data_path, exist_ok=True)
        #
        # save_model_path = os.path.join('./data/random_SVM_Results/', s)
        # os.makedirs(save_model_path, exist_ok=True)
        #
        ...
        # pre_train_y = SVM_Model.predict(train_x)
        # pre_test_y = SVM_Model.predict(test_x)
        # joblib.dump(SVM_Model, os.path.join(save_model_path, 'Random_SVM_' + s + str(i) + '.pkl'))

        # # '''GBDT model'''
        # save_data_path = './data/random_GBDT_Results/'
        # os.makedirs(save_data_path, exist_ok=True)
        #
        # save_model_path = os.path.join('./data/random_GBDT_Results/', s)
        # os.makedirs(save_model_path, exist_ok=True)
        #
        ...
        # pre_train_y = GBDT_model.predict(train_x)
        # pre_test_y = GBDT_model.predict(test_x)
        # joblib.dump(GBDT_model, os.path.join(save_model_path, 'Random_GBDT_' + s + str(i) + '.pkl'))
